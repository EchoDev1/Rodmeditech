                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="cart">🛒 Cart (Sales & Consulting)</option>
                                    <option value="wrench">🔧 Wrench (Installation)</option>
                                    <option value="book">📚 Book (Training)</option>
                                    <option value="tools">⚙️ Tools (Maintenance)</option>
                                    <option value="bell">🔔 Bell (Support)</option>
                                    <option value="building">🏗️ Building (Facility Planning)</option>
                                </select>
                            </div>
